...
public extension Collection {
    ...
    /// GDExtension: Safe protects the array from out of bounds by use of optional.
    ///
    ///        let arr = [1, 2, 3, 4, 5]
    ///        arr[safe: 1] -> 2
    ///        arr[safe: 10] -> nil
...
public extension Collection where Index == Int {
    ...
    /// GDExtension: Get all indices where condition is met.
    ///
    ...
    /// GDExtension: Calls the given closure with an array of size of the parameter slice.
    ///
    ...
    /// GDExtension: Returns an array of slices of length "size" from the array. If array can't be split evenly, the final slice will be the remaining elements.
    ///
...
public extension Collection where Element == IntegerLiteralType, Index == Int {
    ...
    /// GDExtension: Average of all elements in array.
    ///
