...
public extension RangeReplaceableCollection {
    ...
    /// GDExtension: Returns a new rotated collection by the given places.
    ///
    ...
    /// GDExtension: Rotate the collection by the given places.
    ///
    ...
    /// GDExtension: Removes the first element of the collection which satisfies the given predicate.
    ///
    ...
    /// GDExtension: Remove a random value from the collection.
    @discardableResult
    ...
    /// GDExtension: Keep elements of Array while condition is true.
    ///
    ...
    /// GDExtension: Take element of Array while condition is true.
    ///
    ...
    /// GDExtension: Skip elements of Array while condition is true.
    ///
