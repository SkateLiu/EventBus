...
public extension CGSize {
    ...
    /// GDExtension: Returns the aspect ratio.
    var aspectRatio: CGFloat {
        return height == 0 ? 0 : width / height
    }

    /// GDExtension: Returns width or height, whichever is the bigger value.
    var maxDimension: CGFloat {
        return max(width, height)
    }

    /// GDExtension: Returns width or height, whichever is the smaller value.
...
public extension CGSize {
    ...
    /// GDExtension: Aspect fill CGSize.
    ///
...
public extension CGSize {
    ...
    /// GDExtension: Add a CGSize to self.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     sizeA += sizeB
    ...
    /// GDExtension: Subtract two CGSize
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     let result = sizeA - sizeB
    ...
    /// GDExtension: Subtract a CGSize from self.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     sizeA -= sizeB
    ...
    /// GDExtension: Multiply two CGSize
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     let result = sizeA * sizeB
    ...
    /// GDExtension: Multiply a CGSize with a scalar.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let result = sizeA * 5
    ...
    /// GDExtension: Multiply self with a CGSize.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     sizeA *= sizeB
    ...
    /// GDExtension: Multiply self with a scalar.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     sizeA *= 3
