...
public extension Date {
    ...
    /// GDExtension: User’s current calendar.
    ...
    /// GDExtension: Check if date is in future.
    ///
    ...
    /// GDExtension: Check if date is in past.
    ///
    ...
    /// GDExtension: Check if date is within today.
    ///
    /// 	Date().isInToday -> true
    ///
    var isInToday: Bool {
    ...
    /// GDExtension: Check if date is within yesterday.
    ///
    ...
    /// GDExtension: Check if date is within tomorrow.
    ///
    ...
    /// GDExtension: Check if date is within a weekend period.
    var isInWeekend: Bool {
        return calendar.isDateInWeekend(self)
    }

    /// GDExtension: Check if date is within a weekday period.
    var isWorkday: Bool {
        return !calendar.isDateInWeekend(self)
    }

    /// GDExtension: Check if date is within the current week.
    var isInCurrentWeek: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .weekOfYear)
    }

    /// GDExtension: Check if date is within the current month.
    var isInCurrentMonth: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .month)
    }

    /// GDExtension: Check if date is within the current year.
    var isInCurrentYear: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .year)
    }

    /// GDExtension: Nearest five minutes to date.
    ///
    ...
    /// GDExtension: Nearest ten minutes to date.
    ///
    ...
    /// GDExtension: Nearest quarter hour to date.
    ///
    /// 	var date = Date() // "5:57 PM"
    /// 	date.minute = 34 // "5:34 PM"
    ...
    /// GDExtension: Nearest half hour to date.
    ///
    ...
    /// GDExtension: Nearest hour to date.
    ///
    ...
    /// GDExtension: Yesterday date.
    ///
    ///     let date = Date() // "Oct 3, 2019, 10:57:11"
    ///     let yesterday = date.yesterday // "Oct 2, 2019, 10:57:11"
    ///
    var yesterday: Date {
        return calendar.date(byAdding: .day, value: -1, to: self) ?? Date()
    }

    /// GDExtension: Tomorrow's date.
    ///
    ///     let date = Date() // "Oct 3, 2019, 10:57:11"
    ///     let tomorrow = date.tomorrow // "Oct 4, 2019, 10:57:11"
    ///
    var tomorrow: Date {
        return calendar.date(byAdding: .day, value: 1, to: self) ?? Date()
    }

    /// GDExtension: UNIX timestamp from date.
    ///
...
public extension Date {
    ...
    /// GDExtension: Date by adding multiples of calendar component.
    ///
    ...
    /// GDExtension: Add calendar component to date.
    ///
    ...
    /// GDExtension: Date by changing value of calendar component.
    ///
    /// 	let date = Date() // "Jan 12, 2017, 7:07 PM"
    ...
    /// GDExtension: Data at the beginning of calendar component.
    ///
    ...
    /// GDExtension: Date at the end of calendar component.
    ///
    ...
    /// GDExtension: Check if date is in current given calendar component.
    ///
    ...
    /// GDExtension: Date string from date.
    ///
    ...
    /// - Returns: date string.
    func format(withFormat format: String = "yyyy-MM-dd hh:mm:ss") -> String {
    ...
    /// GDExtension: Date and time string from date.
    ///
    ...
    /// GDExtension: Time string from date
    ///
    ...
    /// GDExtension: Day name from date.
    ///
    ...
    /// GDExtension: Month name from date.
    ///
    ...
    /// GDExtension: get number of seconds between two date
    ///
    ...
    /// GDExtension: get number of minutes between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// GDExtension: get number of hours between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// GDExtension: get number of days between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// GDExtension: check if a date is between two other dates
    ///
    /// - Parameters:
    ...
    /// GDExtension: check if a date is a number of date components of another date
    ///
    /// - Parameters:
    ...
    /// GDExtension: Returns a random date within the specified range.
    ///
    ...
    /// GDExtension: Returns a random date within the specified range, using the given generator as a source for randomness.
    ///
    /// - Parameters:
...
public extension Date {
    ...
    /// GDExtension: Create a new date form calendar components.
    ///
    ...
    /// GDExtension: Create new date object from UNIX timestamp.
    ///
    ...
    /// GDExtension: Create date object from Int literal
    ///
    ...
    ///   - format: format
    static func date(dateStr: String, format: String) -> Date? {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
