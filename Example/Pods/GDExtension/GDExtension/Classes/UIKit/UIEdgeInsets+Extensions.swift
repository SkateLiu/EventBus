...
public extension UIEdgeInsets {
    /// GDExtension: Return the vertical insets. The vertical insets is composed by top + bottom.
    ///
    var vertical: CGFloat {
        // Source: https://github.com/MessageKit/MessageKit/blob/master/Sources/GDExtension/UIEdgeInsets%2BExtensions.swift
        return top + bottom
    }

    /// GDExtension: Return the horizontal insets. The horizontal insets is composed by  left + right.
    ///
...
// MARK: - Methods
public extension UIEdgeInsets {
    /// GDExtension: Creates an `UIEdgeInsets` with the inset value applied to all (top, bottom, right, left)
    ///
    ...
    /// GDExtension: Creates an `UIEdgeInsets` with the horizontal value equally divided and applied to right and left.
    ...
    /// GDExtension: Creates an `UIEdgeInsets` based on current value and top offset.
    ///
    /// - Parameters:
    ...
    /// GDExtension: Creates an `UIEdgeInsets` based on current value and left offset.
    ///
    /// - Parameters:
    ...
    /// GDExtension: Creates an `UIEdgeInsets` based on current value and bottom offset.
    ///
    /// - Parameters:
    ...
    /// GDExtension: Creates an `UIEdgeInsets` based on current value and right offset.
    ///
    /// - Parameters:
    ...
    /// GDExtension: Creates an `UIEdgeInsets` based on current value and horizontal value equally divided and applied to right offset and left offset.
    ///
    /// - Parameters:
    ...
    /// GDExtension: Creates an `UIEdgeInsets` based on current value and vertical value equally divided and applied to top and bottom.
    ///
    /// - Parameters:
...
public extension UIEdgeInsets {
    ...
    /// GDExtension: Add all the properties of two `UIEdgeInsets` to create their addition.
    ///
    /// - Parameters:
    ...
    /// GDExtension: Add all the properties of two `UIEdgeInsets` to the left-hand instance.
    ///
    /// - Parameters:
