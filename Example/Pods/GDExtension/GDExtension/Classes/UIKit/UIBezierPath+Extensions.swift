...
public extension UIBezierPath {
    ...
    /// GDExtension: Initializes a UIBezierPath with a line from a CGPoint to another CGPoint.
    ///
    /// - Parameters:
    ...
    /// GDExtension: Initializes a UIBezierPath connecting the given CGPoints with straight lines.
    ///
    ...
    /// GDExtension: Initializes a polygonal UIBezierPath with the given CGPoints. At least 3 points must be given.
    ///
    ...
    /// GDExtension: Initializes a UIBezierPath with an oval path of given size.
    ///
    /// - Parameters:
    ...
    /// GDExtension: Initializes a UIBezierPath with a  rectangular path of given size.
    ///
    /// - Parameters:
