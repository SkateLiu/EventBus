...
// MARK: - Methods
@available(iOS 9.0, *)
public extension GDReference where Base: UIStackView {

    /// GDExtension: Adds array of views to the end of the arrangedSubviews array.
    ///
    ...
    /// GDExtension: Removes all views in stack’s array of arranged subviews.
...
public extension UIStackView {
    /// GDExtension: Initialize an UIStackView with an array of UIView and common parameters.
    ///
